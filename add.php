...
//query for questions table
    ...
    $qry="insert into questions(question_number,question_text) values('$qn','$qt')";
    ...
    //2query
            ...
            $query="insert into options(question_number, is_correct, coption) values('$qn','$is_correct','$value')";
