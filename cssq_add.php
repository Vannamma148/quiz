...
//query for questions table
    ...
    $qry="insert into cssq(question_number,question_text) values('$qn','$qt')";
    ...
    //2query
            ...
            $query="insert into csso(question_number, is_correct, cssoption) values('$qn','$is_correct','$value')";
