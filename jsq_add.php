...
//query for questions table
    ...
    $qry="insert into jsq(question_number,question_text) values('$qn','$qt')";
    ...
    //2query
            ...
            $query="insert into jso(question_number, is_correct, jsoption) values('$qn','$is_correct','$value')";
