...
<body>
    ...
    <main>
        <div class="container">
            ...
            <P>This is a multiple choise quiz to test your PHP Knowledge. </P>
            <ul>
              <li><strong>Number of Questions:</strong><?php echo $total_questions;?></li>
             <li><strong>TYPE:</strong>Multiple Choise</li>
             <li><strong>Estimated Time:</strong><?php echo $total_questions*1.8;?> </li>
            </ul>

            <a href="pquestion.php?n=1" class="start">Start Quize</a>
            </div>
    </main>
       <footer>
        <div class="copyright">
